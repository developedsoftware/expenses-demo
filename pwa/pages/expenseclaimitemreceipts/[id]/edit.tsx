...
const Page: NextComponentType<NextPageContext> = () => {
  ...
  const { data: { data: expenseclaimitemreceipt } = {} } = useQuery<
    FetchResponse<ExpenseClaimItemReceipt> | undefined
  >(["expenseclaimitemreceipt", id], () => getExpenseClaimItemReceipt(id));

  if (!expenseclaimitemreceipt) {
  ...
  return (
    <div>
      ...
      <Form expenseclaimitemreceipt={expenseclaimitemreceipt} />
    </div>
  );
};
