...
import { Form } from "../../../components/expenseclaimitemstatus/Form";
...
const Page: NextComponentType<NextPageContext> = () => {
  ...
  const { data: { data: expenseclaimitemstatus } = {} } = useQuery<
    FetchResponse<ExpenseClaimItemStatus> | undefined
  >(["expenseclaimitemstatus", id], () => getExpenseClaimItemStatus(id));

  if (!expenseclaimitemstatus) {
  ...
  return (
    <div>
      ...
      <Form expenseclaimitemstatus={expenseclaimitemstatus} />
    </div>
  );
};
